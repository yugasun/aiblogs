...
[![GitHub Pages](https://img.shields.io/badge/部署到-GitHub%20Pages-blue)](https://yugasun.github.io/ai-blogs/)
[![mdBook](https://img.shields.io/badge/静态网站生成器-mdBook-orange)](https://rust-lang.github.io/mdBook/)
[![License: MIT](https://img.shields.io/badge/License-MIT-green)](LICENSE)

## 关于本项目

`ai-blogs` 是一个完全由 **AI 生成的静态技术博客系统**，具有以下特点：
...
部署地址: https://yugasun.github.io/ai-blogs/
